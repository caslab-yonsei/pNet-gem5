...
s32 e1000_reset_hw(struct e1000_hw *hw)
{
	...
	////printk(KERN_ALERT "NEPU e1000_reset_hw called\n");
	...
	for(i=0; i < num_queue; i++){
		ew_mq_32(RCTL, i, 0);
		ew_mq_32(TCTL, i, E1000_TCTL_PSP);
	}
	E1000_WRITE_FLUSH();
...
s32 e1000_init_hw(struct e1000_hw *hw)
{
	...
	int j = 0;
	int num_queue = er32(NUM_ENABLED_QUEUES);
	hw->num_queues = num_queue;

	//printk(KERN_INFO "NEPU e1000_init_hw called\n");
	...
	if (hw->mac_type == e1000_82542_rev2_0) {
		...
		for(j = 0; j < num_queue; j ++)
			ew_mq_32(RCTL, j, E1000_RCTL_RST);
	...
	if (hw->mac_type > e1000_82544) {
		for(j = 0; j < num_queue; j ++){
			ctrl = er_mq_32(TXDCTL, j);
			ctrl =
				(ctrl & ~E1000_TXDCTL_WTHRESH) |
				E1000_TXDCTL_FULL_TX_DESC_WB;
			ew_mq_32(TXDCTL, j, ctrl);
		}
	}
...
void e1000_config_collision_dist(struct e1000_hw *hw)
{
	u32 tctl, coll_dist;
	int i = 0;
	int num_queue = hw->num_queues;

	// TODO MQ
	//printk(KERN_INFO "NEPU e1000_config_collision_dist was called\n");
...
static s32 e1000_check_for_serdes_link_generic(struct e1000_hw *hw)
{
	...
	////printk(KERN_ALERT "NEPU e1000_check_for_serdes_link_generic was called\n");
...
s32 e1000_check_for_link(struct e1000_hw *hw)
{
	...
	////printk(KERN_ALERT "NEPU e1000_check_for_link was called\n");
	...
	if ((hw->media_type == e1000_media_type_copper) && hw->get_link_status) {
		...
		if (phy_data & MII_SR_LINK_STATUS) {
			...
			if ((hw->mac_type == e1000_82544 ||
				...
				// TODO MQ
				for(i = 0; i < num_queue; i ++){
					icr = er_mq_32(MQICR, i);
					ew_mq_32(ICS, i, (icr & ~E1000_ICS_LSC));
...
s32 e1000_check_for_link_mq(struct e1000_hw *hw, int qid)
{
	u32 rxcw = 0;
	u32 ctrl;
	u32 status;
	...
	if ((hw->media_type == e1000_media_type_copper) && hw->get_link_status) {
		...
		if (phy_data & MII_SR_LINK_STATUS) {
			...
			if ((hw->mac_type == e1000_82544 ||
				...
				// TODO MQ
				icr = er_mq_32(MQICR, qid);
				ew_mq_32(ICS, qid, (icr & ~E1000_ICS_LSC));
...
s32 e1000_read_phy_reg(struct e1000_hw *hw, u32 reg_addr, u16 *phy_data)
{
	...
	//printk(KERN_ALERT "e1000_read_phy_reg try spin_lock_irqsave 1.1\n");
	spin_lock_irqsave(&e1000_phy_lock, flags);
	//printk(KERN_ALERT "e1000_read_phy_reg succ spin_lock_irqsave 1.1\n");
...
out:
	...
	//printk(KERN_ALERT "e1000_read_phy_reg spin_unlock_irqrestore 1.1\n");
...
s32 e1000_write_phy_reg(struct e1000_hw *hw, u32 reg_addr, u16 phy_data)
{
	...
	//printk(KERN_ALERT "e1000_write_phy_reg try spin_lock_irqsave 1.1\n");
	spin_lock_irqsave(&e1000_phy_lock, flags);
	//printk(KERN_ALERT "e1000_write_phy_reg succ spin_lock_irqsave 1.1\n");
	...
	if ((hw->phy_type == e1000_phy_igp) &&
		...
		if (ret_val) {
			spin_unlock_irqrestore(&e1000_phy_lock, flags);
			//printk(KERN_ALERT "e1000_write_phy_reg spin_unlock_irqrestore 1.1\n");
			return ret_val;
		}
	}
	...
	spin_unlock_irqrestore(&e1000_phy_lock, flags);
	//printk(KERN_ALERT "e1000_write_phy_reg spin_unlock_irqrestore 1.2\n");
